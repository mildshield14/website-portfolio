...
const en: Content = {
  ...
  hero: {
    ...
    bio: "I'm an M.Sc. Computer Science student at Université de Montréal with industry experience in frontend development, process automation, and low-code solutions. My research examines reusable prompt patterns through large-scale prompt analysis, taxonomy design, and specification. My academic experience also includes LLM application development with RAG, LangChain, and CrewAI.",
    currently_label: 'Currently',
    currently_prose: 'Working on strategic process analysis and automation at iA, researching prompt engineering at D&G / MITACS, and building academic tools at UdeM.',
    ...
    items: [
      {
        ...
        current: true,
        summary:
          'Analyzing business processes and supporting workflow automation in financial services.',
        tags: ['Process Analysis', 'Workflow Automation', 'Financial Services'],
      },
      {
...
const fr: Content = {
  ...
  hero: {
    ...
    bio: "Je suis étudiante à la maîtrise en informatique à l'Université de Montréal, avec une expérience en développement front-end, automatisation de processus et solutions low-code. Ma recherche porte sur l'analyse de prompts réels, leur taxonomie et leur spécification. Mon expérience académique comprend aussi le développement d'applications LLM avec RAG, LangChain et CrewAI.",
    currently_label: 'En ce moment',
    currently_prose: "Analyse stratégique de processus et automatisation chez iA Groupe Financier, recherche en ingénierie de prompts chez D&G / MITACS et développement d'outils académiques à l'UdeM.",
    artifact: `promptspec Catalog {\n  patterns: Persona, Recipe, SchemaSpecs\n  output: graph + api\n}`,
    ...
    items: [
      {
        ...
        current: true,
        summary:
          'Analyse de processus d’affaires et soutien à l’automatisation des flux de travail dans les services financiers.',
